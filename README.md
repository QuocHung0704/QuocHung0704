...
| **Backend** | Spring Boot 3, Spring MVC, Spring Security, Spring Data JPA, Hibernate, RESTful API, WebSocket |
| **Frontend** | HTML, CSS, ReactJS, Redux Toolkit, Tailwind CSS |
| **Database & Caching** | PostgreSQL, MySQL, SQL Server, MongoDB, Redis |
| **Identity & Security** | Keycloak (OAuth2 / OIDC), JWT, role-based access control |
...
| :--- | :--- | :--- |
| **[Culture Quest Lite](https://github.com/culture-quest-lite/Back-End)** | Gamified cultural exploration — location check-ins, routes, leaderboards, partner vouchers | Spring Boot, PostgreSQL + Spatial, Keycloak, Redis, PayOS |
